            ...
            if (testUser != null && exams.Count >= 5)
            {
                ...
                context.ExamAttempts.AddRange(
                    new ExamAttempt
                    {
                        ...
                        CompletedAt = DateTime.UtcNow.AddDays(-28).AddMinutes(115),
                        ListeningScore = 280,
                        ReadingScore = 250,
                        TotalScore = 530,
                        IsSubmitted = true
                    ...
                    new ExamAttempt
                    {
                        ...
                        StartedAt = DateTime.UtcNow.AddDays(-21),
                        CompletedAt = DateTime.UtcNow.AddDays(-21).AddMinutes(110),
                        ListeningScore = 320,
                        ReadingScore = 290,
                        TotalScore = 610,
                        IsSubmitted = true
                    ...
                    new ExamAttempt
                    {
                        ...
                        CompletedAt = DateTime.UtcNow.AddDays(-14).AddMinutes(105),
                        ListeningScore = 350,
                        ReadingScore = 310,
                        TotalScore = 660,
                        IsSubmitted = true
                    ...
                    new ExamAttempt
                    {
                        ...
                        CompletedAt = DateTime.UtcNow.AddDays(-7).AddMinutes(100),
                        ListeningScore = 380,
                        ReadingScore = 340,
                        TotalScore = 720,
                        IsSubmitted = true
                    ...
                    {
                        UserId = testUser.UserId,
                        ExamId = exams[4].ExamId,
                        StartedAt = DateTime.UtcNow.AddDays(-2),
                        CompletedAt = DateTime.UtcNow.AddDays(-2).AddMinutes(95),
                        ListeningScore = 415,
                        ReadingScore = 370,
                        TotalScore = 785,
                        IsSubmitted = true
                ...
                if (hana != null)
                {
                    context.ExamAttempts.AddRange(
                        new ExamAttempt
                        {
                            UserId = hana.UserId,
                            ExamId = exams[0].ExamId,
                            StartedAt = DateTime.UtcNow.AddDays(-18),
                            CompletedAt = DateTime.UtcNow.AddDays(-18).AddMinutes(110),
                            ListeningScore = 300,
                            ReadingScore = 270,
                            TotalScore = 570,
                            IsSubmitted = true
                        ...
                        new ExamAttempt
                        {
                            ...
                            CompletedAt = DateTime.UtcNow.AddDays(-10).AddMinutes(105),
                            ListeningScore = 340,
                            ReadingScore = 310,
                            TotalScore = 650,
                            IsSubmitted = true
                        ...
                        new ExamAttempt
                        {
                            ...
                            CompletedAt = DateTime.UtcNow.AddDays(-3).AddMinutes(100),
                            ListeningScore = 370,
                            ReadingScore = 340,
                            TotalScore = 710,
                            IsSubmitted = true
